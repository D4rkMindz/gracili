...
class HttpCode
{
     ...
     * be repeated without the expected header as it indicates that the server doesn't support expectations
     ...
     * digital cash or micro payment scheme, as proposed for example by GNU Taler, but that has not yet happened,
