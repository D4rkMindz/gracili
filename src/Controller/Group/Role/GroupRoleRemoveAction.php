...
/**
 * Class GroupRoleRemoveAction
 */
class GroupRoleRemoveAction implements AuthorizationInterface
{
    public const NAME = 'api.v1.group.role.remove';
    ...
    public function __invoke(
        ...
        $this->group->removeRoleFromGroup($groupId, $roleId, $executorId);

        return $this->json->encode($response, [
            'success' => true,
            'message' => __('Successfully removed role from group'),
