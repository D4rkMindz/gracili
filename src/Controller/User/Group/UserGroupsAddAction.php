...
/**
 * Class UserGroupsAddAction
 */
class UserGroupsAddAction implements AuthorizationInterface
{
    public const NAME = 'api.v1.user.group.add';
    ...
    public function __invoke(
        ...
        $this->authorization->assignGroup($userId, $group['name'], $executorId);

        return $this->json->encode($response, [
            'success' => true,
            'message' => __('Successfully assigned group to user'),
