...
class Init extends Phinx\Migration\AbstractMigration
{
    public function change()
    {
        ...
        $this->table('enqueue', [
            ...
            ->addColumn('delayed_until', 'integer', [
                'null' => true,
                'limit' => MysqlAdapter::INT_BIG,
                'after' => 'priority',
            ])
            ...
            ->addColumn('redeliver_after', 'integer', [
                'null' => true,
                'limit' => MysqlAdapter::INT_BIG,
                'after' => 'delivery_id',
            ])
            ->addIndex(['delivery_id'], [
                'name' => 'IDX_CFC35A6812136921',
                'unique' => false,
            ])
            ->addIndex(['priority', 'published_at', 'queue', 'delivery_id', 'delayed_until', 'id'], [
                'name' => 'IDX_CFC35A6862A6DC27E0D4FDE17FFD7F63121369211A065DF8BF396750',
                'unique' => false,
            ])
            ->addIndex(['redeliver_after', 'delivery_id'], [
                'name' => 'IDX_CFC35A68AA0BDFF712136921',
                'unique' => false,
            ])
            ->addIndex(['time_to_live', 'delivery_id'], [
                'name' => 'IDX_CFC35A68E0669C0612136921',
                'unique' => false,
            ])
            ->create();
        $this->table('group', [
